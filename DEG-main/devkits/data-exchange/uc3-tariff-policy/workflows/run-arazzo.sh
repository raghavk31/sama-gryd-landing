#!/usr/bin/env bash
# Run the uc3-tariff-policy Arazzo workflows via Redocly Respect.
#
...
#
# Usage (from uc3-tariff-policy/workflows/):
...
run_arazzo "$HERE" "data-exchange-tariff" "data-exchange-tariff.arazzo.yaml"
